...
cldoc.SearchWorker = function () {
    ...
    return self.onmessage = (function (_this) {
        return function (ev) {
            var end, i, items, j, len, len1, m, o, p, rec, recid, records, ref2, ref3, ref4, ret, rr, start, word,
                words;
            m = ev.data;
            if (db === null) {
                db = load_db(m.host);
...
cldoc.Page = (function () {
    ...
    Page.render_search = function (result) {
        var a, content, cpage, data, end, item, j, len, len1, len2, o, p, page, pageid, pageidesc, parts, prev, records,
            ref2, ref3, ref4, ref5, res, sortfunc, start, t, tag;
...
cldoc.Function = (function (superClass) {
    ...
    Function.prototype.render = function () {
        var arg, args, argtype, e, i, isover, isprot, isstat, isvirt, j, name, o, ov, override, ref2, ref3, ret, retu,
            returntype;
        e = cldoc.html_escape;
...
cldoc.References = (function (superClass) {
    ...
    References.prototype.render = function () {
        var child, component, e, file, id, j, kw, len, len1, len2, line, loc, name, o, p, ref2, ref3, ref4, refs, ret,
            tp, x;
        ret = '';
        e = cldoc.html_escape;
        ref2 = this.node.children();
